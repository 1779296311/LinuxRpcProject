...
struct qt_meta_stringdata_monitor__MonitorPage_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_monitor__MonitorPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_monitor__MonitorPage_t qt_meta_stringdata_monitor__MonitorPage = {
    {
QT_MOC_LITERAL(0, 0, 20) // "monitor::MonitorPage"
...
static const uint qt_meta_data_monitor__MonitorPage[] = {
...
void monitor::MonitorPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject monitor::MonitorPage::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_monitor__MonitorPage.data,
    qt_meta_data_monitor__MonitorPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *monitor::MonitorPage::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *monitor::MonitorPage::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_monitor__MonitorPage.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int monitor::MonitorPage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    return _id;
}
